...
class _SplashscreenState extends State<Splashscreen> {
  ...
  void initState() {
    super.initState();
    _startTimer();
    routing(); // No need to pass context here, as it's a member function
  }
  ...
  void routing() {
    Future.delayed(const Duration(seconds: 8), () {
      ...
      switch (widget.userrole) { // Use widget.userrole to access the parameter
        case 'Admin':
        ...
        case 'Student':
          ...
          break;
        default:
          targetPage = const AdminDashboard(); // Default case if userrole is unexpected
          break;
      }
