    ...
    builder: (context, orientation, deviceType) {
      return BottomNavigationBar(
        items: [
          ...
          _buildNavItem(Icons.table_chart_outlined, 'Timetable',
              currentIndex == 0, () => navigateToPage(0, context)),
          _buildNavItem(Icons.note_outlined, 'Notes', currentIndex == 1,
              () => navigateToPage(1, context)),
          _buildNavItem(Icons.home_outlined, 'Home', currentIndex == 2,
              () => navigateToPage(2, context)),
          _buildNavItem(Icons.class_outlined, 'Classes', currentIndex == 3,
              () => navigateToPage(3, context)),
          _buildNavItem(Icons.card_giftcard, 'Gift', currentIndex == 4,
              () => navigateToPage(4, context)),
        ],
        ...
        unselectedLabelStyle: const TextStyle(
            fontFamily: 'Roboto', color: Color.fromRGBO(239, 238, 233, 1)),
...
BottomNavigationBarItem _buildNavItem2(
  ...
  return Sizer(
    builder: (context, orientation, deviceType) {
      return BottomNavigationBar(
        // Define navigation items with icons and labels.
        items: [
          _buildNavItem2(Icons.table_chart_outlined, 'Timetable',
              () => navigateToPage(0, context)),
          _buildNavItem2(
              Icons.note_outlined, 'Notes', () => navigateToPage(1, context)),
          _buildNavItem2(
              Icons.home_outlined, 'Home', () => navigateToPage(2, context)),
          _buildNavItem2(Icons.class_outlined, 'Classes',
              () => navigateToPage(3, context)),
          _buildNavItem2(
              Icons.card_giftcard, 'Gift', () => navigateToPage(4, context)),
        ],
        // Define styles for unselected items.
        unselectedItemColor: const Color.fromRGBO(239, 238, 233, 1),
        unselectedFontSize: 9.5.sp,
