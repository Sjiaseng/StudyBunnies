  ...
  return Sizer(
    builder: (context, orientation, deviceType) {
      return BottomNavigationBar(
        items: [
          _buildNavItem(Icons.home_outlined, 'Home', currentIndex == 0,
              () => navigateToPage(0, context)),
          _buildNavItem(Icons.table_chart_outlined, 'Timetable',
              currentIndex == 1, () => navigateToPage(1, context)),
          _buildNavItem(Icons.school_outlined, 'Classes', currentIndex == 2,
              () => navigateToPage(2, context)),
          _buildNavItem(Icons.people_outline, 'Student List', currentIndex == 3,
