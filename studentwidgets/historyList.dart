  ...
  return Expanded(
    child: Padding(
      ...
      child: FutureBuilder<String?>(
        future: storage.read(
            key: 'userID'), // Retrieve the userID from secure storage
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final giftHistory =
                      giftHistories[index].data() as Map<String, dynamic>;
                  final giftID = giftHistory['giftID'] as String;
                  final status = giftHistory['status']
                      as int; // Assuming 'status' is an int field
                  ...
                  return FutureBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, giftSnapshot) {
                      ...
                      if (!giftSnapshot.hasData || !giftSnapshot.data!.exists) {
                        return const Center(
                            child: Text('Gift details not found.'));
                      }

                      final giftData =
                          giftSnapshot.data!.data() as Map<String, dynamic>;
                      final giftImage = giftData['gift_image']
                          as String?; // Assuming the image URL is stored in 'gift_image'
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Padding(
                                  padding:
                                      EdgeInsets.only(left: 5.w, bottom: 0.2.h),
                                  child: Container(
                                    width: 25.w,
                                    height: 18.h,
                                    decoration: BoxDecoration(
                                      ...
                                      image: giftImage != null
                                          ...
                                          : const DecorationImage(
                                              image: AssetImage(
                                                  'images/exchanged_gift_image.png'), // Placeholder image
                                              fit: BoxFit.contain,
                                            ),
                                    ),
                                  ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          'Gift ID: \n${giftID}', // Display giftID as placeholder
                                          style: TextStyle(
                                            fontSize: 9.sp,
                                            color: Colors.black,
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          'Echange Date: \n${giftHistory['requestdate'].toDate().toLocal().toString()}', // Format date as needed
                                          style: TextStyle(
                                            fontSize: 9.sp,
                                            color: Colors.black,
                                            fontFamily: 'Times New Roman',
                            ...
                            Positioned(
                              bottom: 1
                                  .h, // Adjust this value to move the button higher or lower
